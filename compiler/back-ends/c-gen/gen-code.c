    ...
    Module *m)
{
    ...
    if ( GetEncRulesType() == GSER || GetEncRulesType() == GSER_COMP ||
	GetEncRulesType() == BER_COMP ) {

    fprintf (src, "/*\n");
    fprintf (src, " *    %s\n", m->cSrcFileName);
    fprintf (src, " *    \"%s\" ASN.1 module encode/decode/extracting/matching/free C src.\n", m->modId->name);
    fprintf (src, " *    This file was generated by modified eSMACC compiler %s", ctime (&t));
    fprintf (src, " *    The generated files are supposed to be compiled as a module for OpenLDAP Software\n");
    fprintf (src, " */\n\n");
    } else {
    fprintf (src, "/*\n");
    fprintf (src, " *    %s\n", m->cSrcFileName);
    ...
    Module *m)
{
	...
	GetEncRulesType() == BER_COMP ) {
    fprintf (f, " *    %s\n", m->cHdrFileName);
    fprintf (f, " *    \"%s\" ASN.1 module encode/decode/extracting/matching/free C src.\n", m->modId->name);
    fprintf (f, " *    This file was generated by modified eSMACC compiler %s", ctime (&t));
    fprintf (f, " *    The generated files are strongly encouraged to be\n");
    fprintf (f, " *    compiled as a module for OpenLDAP Software\n");
    } else {
    fprintf (f, " *    %s\n", m->cHdrFileName);
